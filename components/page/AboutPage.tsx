...
function AboutPageContentNarrowScreen() {
    return (
        <>
            <ResponsiveImage image="/assets/images/poesy-avatar-2.jpeg" name="Poesy Liang 梁小詩" />
            <div className="mx-10 mt-10 font-bright-grotesk-light opacity-77 text-white">
                <div>
                    <h1 className="text-[16px]">POESY LIANG 梁小詩</h1>
...
function AboutPageContentWideScreen() {
    return (
        <div className="flex flex-1 flex-row">
            ...
            <div className="mx-10 mt-10 font-bright-grotesk-light opacity-77 text-white">
                <div>
                    <h1 className="text-[30px]">POESY LIANG 梁小詩</h1>
                    <p className="text-[20px]">MALAYSIA - TAIWAN (1975)</p>
                </div>
