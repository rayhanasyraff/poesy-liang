        ...
        <>
            ...
            <div className="flex flex-1 flex-col mx-10 mt-10 font-bright-grotesk-light opacity-77 text-white">
                ...
                <div className="mt-10 text-[10px] leading-relaxed space-y-4">
                    ...
                    music &amp; poetry – evident in her pavilion-sized work, the Pirate’s
                    Daughter.
                    </p>
                    ...
                    <p>
                    Poesy is a frequent flyer, who appears on global stages, and routinely clock her calendar in 3 continents each year. She is a prolific writer, the author of a website since 1999 - with enough materials to publish 6 books, 2 movies and a small mountain of poetic zines. As a filmmaker, her heart is primarily set on creating an immersive experience for her blind audience, achieving with sound what her visuals cannot.
                    </p>
                    ...
                    More recently, Poesy's Running Rabbit, a signature since 2000,
                    continues its story in the form of NFT who got to the moon.
                    </p>

                    <p>
                    During her brief stint as the street artist, Poesy's Harry Putter RTC was first spotted in Melaka, and rapidly appeared in Johor, Kuala Lumpur, Singapore, Manila and New York. While the #ChubbPoesy mural is her largest  public commission to date, the longest wall she has ever drawn is to be found at the headquarters of Yayasan Chow Kit, a leading children's foundation in Malaysia - where Poesy spearheaded a Tuesday art program for marginalised children that lasted 12 years.
                    </p>

                    <p>
                    Her famed cat Harry Putter was recently spotted mingling with marine life in a mobile game where he catches fish to feed his fat wife, and bothers to collect glass &amp; plastic waste in the sea. Poesy's projects inevitably awakens our modern society to its original design in order to restore civic standards of the old school - synonymous with the unrelenting mission of Helping Angels 善⾏天使 – Poesy's randomly kind movement since 2007.
                    </p>
                    ...
                    <p>
                    If you say hi to her, a basic "miao" is sufficient and strictly no small talk.
                    </p>
                </div>
            </div>
        </>
