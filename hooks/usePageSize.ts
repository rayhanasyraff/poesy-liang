...
export default function usePageSize() {
    ...
    useEffect(() => {
        ...
        setPageSize({
            width: windowSize.width <= maxWidth ? windowSize.width : maxWidth,
    ...
    }, [pageNumber, windowSize.width, windowSize.height, pageSize.height, pageSize.width, areAllPagesRendered, numPagesRendered, setNumPagesRendered, setAreAllPagesRendered]);
